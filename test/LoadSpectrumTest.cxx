...
TEST_CASE("Load spectrum test")
{
  ...
  attributes.emplace_back(rexsapi::TAttribute{gearCasingComponent.findAttributeById("temperature_lubricant"),
  ...
  attributes.emplace_back(rexsapi::TAttribute{lubricantComponent.findAttributeById("density_at_15_degree_celsius"),
  ...
  SUBCASE("Load case")
  {
    ...
    loadAttributes.emplace_back(rexsapi::TAttribute{gearCasingComponent.findAttributeById("mass_of_component"),
                                                    rexsapi::TUnit{dbModel.findUnitByName("kg")},
                                                    rexsapi::TValue{10.5}});
    ...
    loadAttributes.emplace_back(
      rexsapi::TAttribute{lubricantComponent.findAttributeById("viscosity_at_100_degree_celsius"),
